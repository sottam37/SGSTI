...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <a class="navbar-brand" href="#"><i class="fas fa-server"></i> SGSTI - PRD</a>
    ...
    <div class="container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "SELECT os, dt_atd, uf, grupo, situacao, sla FROM ATENDIMENTOS WHERE dt_atd = '$data_consulta'";
