...
if (isset($_SESSION['usuario'])) {
    header("Location: servidor/sgsti/");
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "SELECT * FROM TECNICOS WHERE idtecnico ='$usuario' AND senha ='$senha'";
    ...
    if ($resultado->num_rows == 1) {
        ...
        header("Location: http://servidor/sgsti/");
        exit();
    } else {
        // Login falhou
        $erro_login = "Credenciais inválidas. Tente novamente.";
        
        header("Location: http://servidor/sgsti/login_erro.php");
    }
}
